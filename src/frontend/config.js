...
function siteInfo() {
	...
	var info = {
		    ...
		    "bio": "A data engineer and integration developer with 6 years of professional experience building and using ETL processes and RESTful APIs. Recently completed a Master's degree in Computer Science with a focus on machine learning, big data processing, and cryptography. In my free time, I like to take photos, cook, play basketball, and go to concerts.",
		    "socials": {
